...
<tr>
	...
	<th class="thTop nowrap" width="20%"><a href="{U_SORT_USERNAME}">{L_USERNAME}</a></th>
	<th class="thTop nowrap" width="5%">{L_COUNTRY}</th>
...
<tr>
	...
	<td class="{usrlist.ROW_CLASS} hcenter"><span class="gen">
		<img src="images/flags/{usrlist.USER_FLAG}.png" alt="{usrlist.USER_COUNTRY}" title="{usrlist.USER_COUNTRY}" width="18" height="12" />
	</span></td>
