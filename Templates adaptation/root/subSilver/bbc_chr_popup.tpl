<link rel="stylesheet" href="{BBC_CHR_SHEET}" type="text/css">
...
function renderCharMapHTML() {
	...
	for (var i=0; i<charmap.length; i++) {
		if (charmap[i][2]==true) {
			...
			+ ' onmouseout="this.className=&#39;charmapOut&#39;;"'
...
<table align="center" border="0" cellspacing="0" cellpadding="2">
    <tr>
        <td colspan="2" class="title">{L_CHARMAP_TITLE}</td>
    </tr>
    <tr>
    ...
    <tr>
	<td align="right" colspan="2"><a class="charmap" href="javascript:window.close();">{L_CLOSE_WINDOW}</a></td>
    </tr>
</table>
</body>
</html>