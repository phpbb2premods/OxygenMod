...
<tr>
  <th class="thHead" colspan="2">{L_MANAGE_TITLE}</th>
</tr>
<tr>
  <td id="configjointfiles_flag" class="row1 gensmall" align="right" width="10">&raquo;</td>
  <td style="cursor: pointer; font-weight: normal;" class="row1" onmouseover="this.className='row2'; this.style.cursor='pointer'; this.style.fontWeight='bold';" onmouseout="this.className='row1'; this.style.fontWeight='normal';" onclick="dom_menu.set('configjointfiles'); return false;"><div id="configjointfiles_opt" class="gensmall" style="font-weight: bold;"><a href="#" onclick="dom_menu.set('configjointfiles'); return false;">{L_ATTACHMENT_SETTINGS}</a></div></td>
</tr>
<tr>
  <td id="configsizefiles_flag" class="row2 gensmall" align="right" width="10">&raquo;</td>
  <td style="cursor: pointer; font-weight: normal;" class="row1" onmouseover="this.className='row2'; this.style.cursor='pointer'; this.style.fontWeight='bold';" onmouseout="this.className='row1'; this.style.fontWeight='normal';" onclick="dom_menu.set('configsizefiles'); return false;"><div id="configsizefiles_opt" class="gensmall"><a href="#" onclick="dom_menu.set('configsizefiles'); return false;">{L_ATTACHMENT_FILESIZE_SETTINGS}</a></div></td>
</tr>
<tr>
  <td id="confignumberfiles_flag" class="row2 gensmall" align="right" width="10">&raquo;</td>
  <td style="cursor: pointer; font-weight: normal;" class="row1" onmouseover="this.className='row2'; this.style.cursor='pointer'; this.style.fontWeight='bold';" onmouseout="this.className='row1'; this.style.fontWeight='normal';" onclick="dom_menu.set('confignumberfiles'); return false;"><div id="confignumberfiles_opt" class="gensmall"><a href="#" onclick="dom_menu.set('confignumberfiles'); return false;">{L_ATTACHMENT_NUMBER_SETTINGS}</a></div></td>
</tr>
<tr>
  <td id="filesoptions_flag" class="row2 gensmall" align="right" width="10">&raquo;</td>
  <td style="cursor: pointer; font-weight: normal;" class="row1" onmouseover="this.className='row2'; this.style.cursor='pointer'; this.style.fontWeight='bold';" onmouseout="this.className='row1'; this.style.fontWeight='normal';" onclick="dom_menu.set('filesoptions'); return false;"><div id="filesoptions_opt" class="gensmall"><a href="#" onclick="dom_menu.set('filesoptions'); return false;">{L_ATTACHMENT_OPTIONS_SETTINGS}</a></div></td>
</tr>
<tr>
  <td id="ftpconfig_flag" class="row2 gensmall" align="right" width="10">&raquo;</td>
  <td style="cursor: pointer; font-weight: normal;" class="row1" onmouseover="this.className='row2'; this.style.cursor='pointer'; this.style.fontWeight='bold';" onmouseout="this.className='row1'; this.style.fontWeight='normal';" onclick="dom_menu.set('ftpconfig'); return false;"><div id="ftpconfig_opt" class="gensmall"><a href="#" onclick="dom_menu.set('ftpconfig'); return false;">{L_ATTACHMENT_FTP_SETTINGS}</a></div></td>
</tr>
</table>

</td><td valign="top" width="100%">

<table id="configjointfiles" class="forumline" border="0" cellpadding="4" cellspacing="1" width="100%">
	<tr>
  ...
  <tr>
		...
		<td class="row2" width="45%"><input type="text" size="25" maxlength="100" name="upload_dir" class="post" value="{UPLOAD_DIR}" /></td>
	</tr>
	<tr>
		<td class="row1">{L_ATTACHMENT_IMG_PATH}<br /><span class="gensmall">{L_IMG_PATH_EXPLAIN}</span></td>
		<td class="row2"><input type="text" size="25" maxlength="100" name="upload_img" class="post" value="{ATTACHMENT_IMG_PATH}" /></td>
	</tr>
	<tr>
		<td class="row1">{L_ATTACHMENT_TOPIC_ICON}<br /><span class="gensmall">{L_TOPIC_ICON_EXPLAIN}</span></td>
		<td class="row2"><input type="text" size="25" maxlength="100" name="topic_icon" class="post" value="{TOPIC_ICON}" /></td>
	</tr>
	<tr>
		<td class="row1">{L_DISPLAY_ORDER}<br /><span class="gensmall">{L_DISPLAY_ORDER_EXPLAIN}</span></td>
...
</table><table id="configsizefiles" style="display:none" border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
	...
	<tr>
		...
		<td class="row2" width="45%"><input type="text" size="8" maxlength="15" name="max_filesize" class="post" value="{MAX_FILESIZE}" /> {S_FILESIZE}</td>
	</tr>
	<tr>
		<td class="row1">{L_ATTACH_QUOTA}<br /><span class="gensmall">{L_ATTACH_QUOTA_EXPLAIN}</span></td>
	...
	<tr>
		<td class="row1">{L_MAX_FILESIZE_PM}<br /><span class="gensmall">{L_MAX_FILESIZE_PM_EXPLAIN}</span></td>
		<td class="row2"><input type="text" size="8" maxlength="15" name="max_filesize_pm" class="post" value="{MAX_FILESIZE_PM}" /> {S_FILESIZE_PM}</td>
	</tr>
	<tr>
		<td class="row1">{L_DEFAULT_QUOTA_LIMIT}<br /><span class="gensmall">{L_DEFAULT_QUOTA_LIMIT_EXPLAIN}</span></td>
		<td class="row2"><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
		<tr>
...
</table><table id="confignumberfiles" style="display:none" border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
		<th class="thHead" colspan="2">{L_ATTACHMENT_NUMBER_SETTINGS}</th>
	</tr>
	<tr>
		<td class="row1">{L_MAX_ATTACHMENTS}<br /><span class="gensmall">{L_MAX_ATTACHMENTS_EXPLAIN}</span></td>
		<td class="row2" width="45%"><input type="text" size="3" maxlength="3" name="max_attachments" class="post" value="{MAX_ATTACHMENTS}" /></td>
	</tr>
	<tr>
		<td class="row1">{L_MAX_ATTACHMENTS_PM}<br /><span class="gensmall">{L_MAX_ATTACHMENTS_PM_EXPLAIN}</span></td>
...
</table><table id="filesoptions" style="display:none" border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
		<th class="thHead" colspan="2">{L_ATTACHMENT_OPTIONS_SETTINGS}</th>
	</tr>
	<tr>
		<td class="row1">{L_DISABLE_MOD}<br /><span class="gensmall">{L_DISABLE_MOD_EXPLAIN}</span></td>
		<td class="row2" width="45%"><input type="radio" name="disable_mod" value="1" {DISABLE_MOD_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="disable_mod" value="0" {DISABLE_MOD_NO} /> {L_NO}</td>
	</tr>
	<tr>
		<td class="row1">{L_PM_ATTACH}<br /><span class="gensmall">{L_PM_ATTACH_EXPLAIN}</span></td>
	...
	<tr>
		<td class="row1">{L_ATTACHMENT_TOPIC_REVIEW}<br /><span class="gensmall">{L_ATTACHMENT_TOPIC_REVIEW_EXPLAIN}</span></td>
	...
	<tr>
		<td class="row1">{L_SHOW_APCP}<br /><span class="gensmall">{L_SHOW_APCP_EXPLAIN}</span></td>
...
</table><table id="ftpconfig" style="display:none" border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
		<th class="thHead" colspan="2">{L_ATTACHMENT_FTP_SETTINGS}</th>
	</tr>
  <!-- BEGIN switch_ftp -->
	<tr>
		<td class="row1">{L_FTP_UPLOAD}<br /><span class="gensmall">{L_FTP_UPLOAD_EXPLAIN}</span></td>
		<td class="row2" width="45%"><input type="radio" name="allow_ftp_upload" value="1" {FTP_UPLOAD_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="allow_ftp_upload" value="0" {FTP_UPLOAD_NO} /> {L_NO}</td>
	</tr>
	<tr>
		<td class="row1">{L_ATTACHMENT_FTP_SERVER}<br /><span class="gensmall">{L_ATTACHMENT_FTP_SERVER_EXPLAIN}</span></td>
		<td class="row2"><input type="text" size="20" maxlength="100" name="ftp_server" class="post" value="{FTP_SERVER}" /></td>
	</tr>
	<tr>
		<td class="row1">{L_ATTACHMENT_FTP_PATH}<br /><span class="gensmall">{L_ATTACHMENT_FTP_PATH_EXPLAIN}</span></td>
		<td class="row2"><input type="text" size="20" maxlength="100" name="ftp_path" class="post" value="{FTP_PATH}" /></td>
	</tr>
	<tr>
		<td class="row1">{L_DOWNLOAD_PATH}<br /><span class="gensmall">{L_DOWNLOAD_PATH_EXPLAIN}</span></td>
		<td class="row2"><input type="text" size="20" maxlength="100" name="download_path" class="post" value="{DOWNLOAD_PATH}" /></td>
	</tr>
	<tr>
		<td class="row1">{L_FTP_PASSIVE_MODE}<br /><span class="gensmall">{L_FTP_PASSIVE_MODE_EXPLAIN}</span></td>
