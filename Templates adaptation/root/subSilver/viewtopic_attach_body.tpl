...
<!-- BEGIN attach -->
	...
	<tr>
		<td colspan="2" align="center"><br /><img resizemod="on" onload="rmw_img_loaded(this)" src="{postrow.attach.cat_images.IMG_SRC}" alt="{postrow.attach.cat_images.L_ATTACHED_FILE}{postrow.attach.cat_images.DOWNLOAD_NAME}" title="{postrow.attach.cat_images.L_ATTACHED_FILE}{postrow.attach.cat_images.DOWNLOAD_NAME}" border="0" /><br /><br /></td>
	</tr>
	</table>
	...
	<tr>
		<td align="center" valign="middle"><a href="{postrow.attach.cat_thumb_images.IMG_SRC}" target="_blank"><img src="{postrow.attach.cat_thumb_images.IMG_THUMB_SRC}" alt="{postrow.attach.cat_images.L_ATTACHED_FILE}{postrow.attach.cat_thumb_images.DOWNLOAD_NAME}, {postrow.attach.cat_thumb_images.FILESIZE} {postrow.attach.cat_thumb_images.SIZE_VAR}
	{postrow.attach.cat_thumb_images.L_DOWNLOADED_VIEWED} {postrow.attach.cat_thumb_images.L_DOWNLOAD_COUNT}

	{postrow.attach.cat_thumb_images.COMMENT}" title="{postrow.attach.cat_images.L_ATTACHED_FILE}{postrow.attach.cat_thumb_images.DOWNLOAD_NAME}, {postrow.attach.cat_thumb_images.FILESIZE} {postrow.attach.cat_thumb_images.SIZE_VAR}
	{postrow.attach.cat_thumb_images.L_DOWNLOADED_VIEWED} {postrow.attach.cat_thumb_images.L_DOWNLOAD_COUNT}
