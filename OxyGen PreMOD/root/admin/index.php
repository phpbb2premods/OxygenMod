...
//-- fin mod : dhtml menu for acp ----------------------------------------------

//-- mod : rank color system ---------------------------------------------------
//-- add
		'U_VERSIONS_CHECK' => append_sid('admin_versions.'.$phpEx.'?pane=right'),
		'L_VERSIONS_CHECK' => $lang['Versions'],
...
MOD-*/
//-- add
		'body' => 'admin/sai_index_body.tpl')
	);

	include('./sexy_admin_index.'.$phpEx);
	$sai = new sexy_admin_index($lang);
	$template->assign_vars( $sai->vars_language() );
	$template->assign_vars( $sai->vars_statistics() );
//-- fin mod : sexy administration index ---------------------------------------
...
//-- mod : ip country flag -----------------------------------------------------
//-- add
	$sql = str_replace('SELECT ', 'SELECT session_cf_iso3661_1, ', $sql);
//-- fin mod : ip country flag -------------------------------------------------
	if(!$result = $db->sql_query($sql))
	{
...
MOD-*/
//-- add
					'USERNAME' => '<img src="../images/flags/small/' . $onlinerow_reg[$i]['session_cf_iso3661_1'] . '.png" width="14" height="9" border="0" alt="' . $lang['IP2Country'][$onlinerow_reg[$i]['session_cf_iso3661_1']] . '" title="' . $lang['IP2Country'][$onlinerow_reg[$i]['session_cf_iso3661_1']] . '" />&nbsp;' . $username, 
//-- fin mod : ip country flag -------------------------------------------------
...
MOD-*/
//-- add
				'USERNAME' => '<img src="../images/flags/small/' . $onlinerow_guest[$i]['session_cf_iso3661_1'] . '.png" width="14" height="9" border="0" alt="' . $lang['IP2Country'][$onlinerow_guest[$i]['session_cf_iso3661_1']] . '" title="' . $lang['IP2Country'][$onlinerow_guest[$i]['session_cf_iso3661_1']] . '" />&nbsp;' . $lang['Guest'],
//-- fin mod : ip country flag -------------------------------------------------
...
MOD-*/
//-- add
				'USERNAME' => '<img src="../images/flags/small/' . $onlinerow_spider[$i]['session_cf_iso3661_1'] . '.png" width="14" height="9" border="0" alt="' . $lang['IP2Country'][$onlinerow_spider[$i]['session_cf_iso3661_1']] . '" title="' . $lang['IP2Country'][$onlinerow_spider[$i]['session_cf_iso3661_1']] . '" />&nbsp;' . $onlinerow_spider[$i]['is_robot'],
//-- fin mod : ip country flag -------------------------------------------------
