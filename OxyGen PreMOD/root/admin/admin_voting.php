...
if( !empty($setmodules) )
{
	...
	$module['Users']['Admin_Vote_Title'] = $filename;
	return;
}
...
$template->set_filenames(array(
	'pollbody' => 'admin/admin_voting_body.tpl'
));
...
//-- add
$sql = str_replace('SELECT DISTINCT', 'SELECT DISTINCT u.user_level, u.user_color, u.user_group_id, ', $sql);
