...
// and add Global Announce in the comment header
//-- modify
//                View      Read      Post      Reply     Edit     Delete    Sticky   Announce   Global Announce    Vote      Poll
$simple_auth_ary = array(
	...
	3  => array(AUTH_ALL, AUTH_ACL, AUTH_ACL, AUTH_ACL, AUTH_ACL, AUTH_ACL, AUTH_ACL, AUTH_MOD, AUTH_MOD, AUTH_ACL, AUTH_ACL),
	4  => array(AUTH_ACL, AUTH_ACL, AUTH_ACL, AUTH_ACL, AUTH_ACL, AUTH_ACL, AUTH_ACL, AUTH_MOD, AUTH_MOD, AUTH_ACL, AUTH_ACL),
...
//	, 'auth_bump'
//-- modify
$forum_auth_fields = array('auth_view', 'auth_read', 'auth_post', 'auth_reply', 'auth_edit', 'auth_bump', 'auth_delete', 'auth_sticky', 'auth_announce', 'auth_global_announce', 'auth_vote', 'auth_pollcreate');
//-- fin mod : bump topic ------------------------------------------------------
//-- fin mod : annonce globale -------------------------------------------------
