...
//-- add
if( $board_config['faq_access'] == ADMIN && $userdata['user_level'] != ADMIN )
{
	message_die(GENERAL_MESSAGE, $lang['Not_Authorised']);
}
else if ( $board_config['faq_access'] == MOD && ( $userdata['user_level'] != MOD && $userdata['user_level'] != ADMIN ) )
{
	message_die(GENERAL_MESSAGE, $lang['Not_Authorised']);
}
else if( $board_config['faq_access'] == USER && !$userdata['session_logged_in'] )
{
	message_die(GENERAL_MESSAGE, $lang['Not_Authorised']);
}
...
//-- fin mod : dhtml collapsible faq -------------------------------------------
make_jumpbox('viewforum.'.$phpEx);

$template->assign_vars(array(
//-- mod : dhtml collapsible faq -----------------------------------------------
//-- add
