...
<form action="{S_GROUPCP_ACTION}" method="post" name="post">
  <table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	...
	<tr>
	  <td class="catSides" colspan="9" height="28"><span class="cattitle">{L_GROUP_OWNER}</span></td>
	</tr>
	<tr>
	  ...
	  <td class="row1" align="center"><span class="gen"><a href="{U_MOD_VIEWPROFILE}" alt="{L_VIEWPROFILE}" title="{L_VIEWPROFILE}"{MOD_STYLE}>{MOD_USERNAME}</a></span></td>
	  ...
	  <td class="row1" align="center"><span class="gen">&nbsp;{MOD_WWW_IMG}&nbsp;</span></td>
	  <td class="row1" align="center">&nbsp;</td>
	</tr>
	<!-- BEGIN member_row -->
	<!-- BEGIN member_type -->
	<tr>
		<td class="catSides" colspan="9" height="28"><span class="cattitle">{member_row.member_type.L_TYPE}</span></td>
	</tr>
	<!-- END member_type -->
	<tr>
	  ...
	  <td class="{member_row.ROW_CLASS}" align="center"><span class="gen"><a href="{member_row.U_VIEWPROFILE}" alt="{L_VIEWPROFILE}" title="{L_VIEWPROFILE}"{member_row.STYLE}>{member_row.USERNAME}</a></span></td>
	...
	<tr>
		<td class="catSides" colspan="9" height="28"><span class="cattitle">{L_GROUP_MEMBERS}</span></td>
	</tr>
	<tr>
  ...
  <table width="100%" cellspacing="2" cellpadding="2" border="0">
	<tr>
	  <td align="left" valign="top">
		...
		<input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></span><br />
		<!-- END switch_mod_option -->
