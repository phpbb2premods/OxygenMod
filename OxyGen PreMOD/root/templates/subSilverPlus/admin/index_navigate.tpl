...
<tr>
	<td align="center"><table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	<tr>
		<th height="25" class="thHead">{L_ADMIN}</th>
	</tr>
	<tr>
	...
	<tr>
		<td class="row1"><span class="genmed"><a href="{U_VERSIONS_CHECK}" target="main" class="genmed">{L_VERSIONS_CHECK}</a></span></td>
	</tr>
	<!-- BEGIN catrow -->
	<tr>
	...
	<tr>
		<td class="row1"><div id="menuCat_{catrow.MENU_CAT_ID}" style="display:block;"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="bodyline">
		<!-- BEGIN modulerow -->
		<tr>
			<td class="row1"><div id="menuCat_{catrow.MENU_CAT_ID}_{catrow.modulerow.ROW_COUNT}" style="display:block;" class="genmed"><a href="{catrow.modulerow.U_ADMIN_MODULE}" target="main" class="genmed">{catrow.modulerow.ADMIN_MODULE}</a></div></td>
		</tr>
		<!-- END modulerow -->
		</table></div></td>
	</tr>
