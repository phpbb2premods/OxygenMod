...
<!-- BEGIN img --><img resizemod="on" onload="rmw_img_loaded(this)" alt="{URL}" src="{URL}" border="0" /><!-- END img -->

<!-- BEGIN url --><a class="postlink" href="{URL}" target="_blank">{DESCRIPTION}</a><!-- END url -->

<!-- BEGIN email --><a class="postlink" href="mailto:{EMAIL}">{EMAIL}</a><!-- END email -->
...
</div><span class="postbody"><!-- END php_close -->
