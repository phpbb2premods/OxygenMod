...
//-- add
define('EXT_HOST_TABLE', $table_prefix.'ext_host');
...
//-- mod : trashbox ------------------------------------------------------------
//-- add
define('PRIVMSGS_TRASH_IN_MAIL', 6);
define('PRIVMSGS_TRASH_OUT_MAIL', 7);
//-- fin mod : trashbox --------------------------------------------------------

//-- mod : instant msg ---------------------------------------------------------
//-- add
define('INSTANTMSG_TABLE', $table_prefix . 'instant_msg');
//-- fin mod : instant msg -----------------------------------------------------

//-- mod : annonce globale -----------------------------------------------------
//-- add
define('AUTH_GLOBAL_ANNOUNCE', 12);
...
define( 'LOG_CONFIG_TABLE', $table_prefix . 'log_config' );
define( 'LOG_TYPE_ADMIN', 0 );
define( 'LOG_TYPE_MOD', 1 );
