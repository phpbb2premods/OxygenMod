...
* @version $Id: class_bdays.php,v 0.6 10/06/2006 14:16 reddog Exp $
...
class bdays
{
	...
	function get_user_bday($user_bday, $username, $topics='')
	{
		...
		$bday_tmp = date($lang['bday_date_format'], mktime(0, 0, 1, $bday_month, $bday_day, 1972));
		$bday_born = str_replace('1972', $bday_year, $bday_tmp);
