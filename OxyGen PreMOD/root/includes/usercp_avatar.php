...
//	&$message
//-- modify
function display_avatar_gallery($mode, &$category, &$user_id, &$email, &$current_email, &$coppa, &$username, &$email, &$new_password, &$cur_password, &$password_confirm, &$icq, &$aim, &$msn, &$skype, &$yim, &$website, &$location, &$occupation, &$interests, &$bday_date, &$message, &$viewemail, &$notifypm, &$popup_pm, &$notifyreply, &$attachsig, &$allowhtml, &$allowbbcode, &$allowsmilies, &$postspp, &$topicspp, &$hideonline, &$style, &$language, &$timezone, &$dateformat, &$session_id, &$user_qp_settings, &$gender)
...
//-- mod : quick post es -------------------------------------------------------
//-- add
	list($user_qp, $user_qp_show, $user_qp_subject, $user_qp_bbcode, $user_qp_smilies, $user_qp_more) = explode('-', $user_qp_settings);
// here we added
...
//	'message'
//-- modify
	$params = array('coppa', 'user_id', 'username', 'email', 'current_email', 'cur_password', 'new_password', 'password_confirm', 'icq', 'aim', 'msn', 'skype', 'yim', 'website', 'location', 'occupation', 'interests', 'bday_day', 'bday_month', 'bday_year', 'message', 'viewemail', 'notifypm', 'popup_pm', 'notifyreply', 'attachsig', 'allowhtml', 'allowbbcode', 'allowsmilies', 'postspp', 'topicspp', 'hideonline', 'style', 'language', 'timezone', 'dateformat', 'user_qp', 'user_qp_show', 'user_qp_subject', 'user_qp_bbcode', 'user_qp_smilies', 'user_qp_more', 'gender');
//-- fin mod : pastisd - signature editor --------------------------------------
//-- fin mod : users set posts & topics count ----------------------------------
//-- fin mod : gender ----------------------------------------------------------
//-- fin mod : birthday --------------------------------------------------------
