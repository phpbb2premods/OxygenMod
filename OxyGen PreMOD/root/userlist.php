...
//-- mod : ip country flag -----------------------------------------------------
//-- add
				'USER_FLAG' => $this->data[$user_id]['user_cf_iso3661_1'],
				'USER_COUNTRY' => $lang['IP2Country'][$this->data[$user_id]['user_cf_iso3661_1']],
//-- fin mod : ip country flag -------------------------------------------------
...
//-- add
				'AVATAR_MAX_WIDTH' => $board_config['avatar_max_width'],
				'AVATAR_MAX_HEIGHT' => $board_config['avatar_max_height'],
...
//-- mod : ip country flag -----------------------------------------------------
//-- add
		if ($this->data[$user_id]['user_id'] == -1)
		{
			$avatar = '"images/avatars/gallery/ipcf_flags/guest.gif" alt="' . $lang['IPCF_Guest'] . '" title="' . $lang['IPCF_Guest'] . '"';
		}
		else if (!$this->data[$user_id]['user_avatar_type'])
		{
			$avatar = 'images/avatars/gallery/ipcf_flags/' . $this->data[$user_id]['user_cf_iso3661_1'] . '.gif';
		}
//-- fin mod : ip country flag -------------------------------------------------
