...
//-- mod : oxygen premod -------------------------------------------------------
//-- add
$lang['Files_folders'] = 'Files and directories';
$lang['Files_folders_explain'] = '<b>Required</b> - In order to function correctly, OxyGen PreMOD needs to be able to access or write to certain files or directories. If you see “<b style="color:red">Not Found</b>”, you need to create the relevant file or directory. If you see “<b style="color:red">Unwriteable</b>”, you need to change the permissions on the file or directory to allow OxyGen PreMOD to write to it.';

$lang['Optional_files_folders'] = 'Optional files and directories';
$lang['Optional_files_folders_explain'] = '<b>Optional</b> - These files, directories or permission settings are not required. The installation system will attempt to use various techniques to create them if they do not exist or cannot be written to. However, the presence of these will speed installation.';

$lang['Found'] = '<b style="color:green">Found</b>';
$lang['Not_found'] = '<b style="color:red">Not found</b>';
$lang['Writeable'] = ', <b style="color:green">writeable</b>';
$lang['Unwriteable'] = ', <b style="color:red">unwriteable (CHMOD 777)</b>';
$lang['Unmodifiable'] = ', <b style="color:red">unwriteable (CHMOD 666)</b>';
