...
$lang['xs_title'] = 'MOD eXtreme Styles';
...
$lang['xs_main_comment1'] = 'Ceci est le menu principal du MOD eXtreme Styles. Il y a bon nombre de fonctionnalités disponible depuis cette interface, cette page se présente donc comme un guide. Une petite explication se trouve en dessous de chaque fonction.<br /><br />Note : Ce MOD remplace le système de gestion des thèmes de phpBB. Vous trouverez les fonctions par défaut de phpBB dans cette liste, mais celles-ci seront optimisées et auront de nouvelles fonctionnalités.<br /><br />Pour toutes questions n\'hésitez pas à visiter <a href="http://www.stsoftware.biz/forum" target="_blank">le forum de support</a> où vous pourrez trouver de l\'aide pour ce MOD.';
$lang['xs_main_comment2'] = 'Le MOD eXtreme Styles permet à l\'administrateur de stocker des thèmes entiers dans des fichiers .style . Les thèmes sont stockés dans de petits fichiers compressés et ainsi permettent d\'éviter les téléchargements/envois incéssants de nombreux fichiers. Les fichiers du style sont compressés et permettent que le téléchargement/envoi soit plus efficace que l\'actuel téléchargement/envoi des fichiers de thèmes.';
$lang['xs_main_comment3'] = 'Toutes les fonctions de gestion de thèmes de phpBB sont remplacés par le MOD eXtreme Styles.<br /><br /><a href="{URL}">Cliquer ici</a> pour voir le menu.';
...
$lang['xs_clone_styles_explain'] = 'Ceci vous permet de rapidement de dupliquer des thèmes ou bien un template complet.';
$lang['xs_download_styles'] = 'Télécharger des thèmes';
$lang['xs_download_styles_explain'] = 'Ceci vous permet de rapidement de télécharger et installer des thèmes depuis des sites. Vous pouvez configurer la liste des sites vous-mêmes.';
...
$lang['xs_ftp_comment1'] = 'Afin d\'utiliser cette fonctionnalité, vous devez choisir la méthode d\'envoi du fichier. Si vous sélectionnez par FTP, le mot de passe ne sera pas enregistré et le MOD eXtreme Styles vous demandera un mot de passe à chaque fois que vous voudrez accéder à une fonction nécéssitant un accès FTP. Si vous sélectionnez un système de fichiers locaux, assurez-vous dans ce cas que tous les répertoires requis sont inscriptibles.';
$lang['xs_ftp_comment2'] = 'Pour utiliser cette fonctionnalité, vous devez régler la configuration du FTP. Un mot de passe ne sera pas gardé et le MOD eXtreme Styles vous demandera un mot de passe à chaque fois que vous voudrez accéder à une fonction nécéssitant un accès FTP.';
$lang['xs_ftp_comment3'] = 'Attention: les fonctions FTP sont désactivées sur ce serveur. Vous ne pourrez pas utiliser les fonctions du MOD eXtreme Styles qui requiert un accès FTP.';

$lang['xs_ftp_title'] = 'Configuration FTP';

$lang['xs_ftp_explain'] = 'Le FTP est utilisé pour envoyer de nouveaux thèmes. Si vous souhaitez utiliser la fonction d\'importation de thèmes, vous devrez régler la configuration du FTP en conséquence. Le MOD eXtreme Styles tente de détecter automatiquement la configuration quand et si cela est possible.';

$lang['xs_ftp_error_fatal'] = 'Fonctions FTP désactivées dur ce serveur. Impossible de continuer.';
...
$lang['xs_ftp_log_upload'] = 'Fichier {FILE} envoyé';
...
$lang['xs_ftp_select_method'] = 'Choisir la méthode d\'envoi';
...
$lang['xs_config_warning_explain'] = 'Le répertoire du cache n\'est pas inscriptible. Le MOD eXtreme Styles peut tenter de réparer ce problème.<br /><a href="{URL}">Cliquer ici</a> pour essayer de changer l\'accès au répertoire du cache.<br /><br />Si le cache ne fonctionne pas sur votre serveur pour une quelconque raison, ne vous inquiétez pas le MOD eXtreme Styles<br />augmente significativement la vitesse de votre forum même sans cache.';
...
$lang['xs_config_title'] = 'Réglages du MOD eXtreme Styles v{VERSION}';
$lang['xs_config_cache'] = 'Configuration du Cache';

$lang['xs_config_navbar'] = 'Afficher sur la frame de gauche:';
$lang['xs_config_navbar_explain'] = 'Vous pouvez choisir quelles fonctions seront affichées dans la frame de gauche dans le panneau d\'administration.';
...
$lang['xs_config_use_cache_explain'] = 'Le cache est sauvegardé sur le disque et accélerera le système de templates car il n\'y aura plus besoin de compiler le template à chaque fois qu\'il est affiché.';
...
// Debug info
$lang['xs_debug_header'] = 'Informations de débogage';
$lang['xs_debug_explain'] = 'Ceux sont les informatons de débogage. Utilisé pour trouver/réparer les problèmes lors de la configuration du cache.';
...
$lang['xs_debug_data'] = 'Données du débogage:';
...
$lang['xs_check_ok'] = 'Fichier "%s" disponible en écriture. Tout semble fonctionner.';
$lang['xs_error_demo_edit'] = 'Vous ne pouvez pas éditer le fichier en mode démo';
$lang['xs_error_not_installed'] = 'Le MOD eXtreme Styles n\'est pas installé. Vous avez omis d\'envoyer le fichier suivant : includes/template.php';
...
$lang['xs_compile_all_lc'] = 'compiler tous les thèmes';
...
$lang['xs_import_explain'] = 'Ceci vous permet d\'importer des thèmes, ainsi qu\en installer et en mettre à jour automatiquement.<br /><br />Note : si vous avez installé d\'autres MODs (excepté le MOD eXtreme Styles) sur ce forum, faites attention lorsque vous importez des thèmes car des thèmes peuvent ne pas être compatible avec votre forum. Vous pouvez uniquement installer des thèmes qui ont les mêmes modifications que les autres thèmes que vous avez configuré sur votre forum.';
...
$lang['xs_add_styles_web_get'] = 'Le télécharger';
$lang['xs_add_styles_copy'] = 'Copier à partir d\'un fichier en local ';
...
$lang['xs_download_explain2'] = 'Ceci vous permet de rapidement de télécharger et installer des thèmes directement depuis différents sites. Cliquez sur le lien près du nom du site et vous serez redirigés vers une page de téléchargement de thèmes.<br /><br />Vous pouvez également gérer la liste des sites.';
...
$lang['xs_import_uploaded'] = 'Thème envoyé.';
$lang['xs_import_installed'] = 'Thème envoyé et installé.';
$lang['xs_import_notinstall'] = 'Thème envoyé, mais erreur en installant le thème (erreur sql).';
$lang['xs_import_notinstall2'] = 'Thème envoyé, mais erreur en installant le thème: aucun thème trouvé dans theme_info.cfg';
$lang['xs_import_notinstall3'] = 'Thème envoyé, mais erreur en installant le thème: aucune entrée "{STYLE}" trouvée dans theme_info.cfg';
$lang['xs_import_notinstall4'] = 'Thème envoyé, mais erreur en installant le thème: impossible d\'obtenir l\'information concernant themes_id';
$lang['xs_import_notinstall5'] = 'Thème envoyé, mais erreur en installant le thème: impossible de mettre à jour la table des thèmes';
...
$lang['xs_import_nodownload3'] = 'Fichier non envoyé.';
...
$lang['xs_import_uploaded4'] = 'Thème envoyé. Vous pouvez désormais l\'importer.<br /><br /><a href="{URL}">Cliquer ici</a> pour importer le thème.';
...
$lang['xs_export_error_uploading'] = 'Erreur lors de l\'envoi du thème';
$lang['xs_export_uploaded'] = 'Fichier envoyé.';
...
$lang['xs_theme_cloned'] = 'Thème dupliqué.';
$lang['xs_invalid_style_name'] = 'Nom de thème invalide.';
$lang['xs_clone_style_exists'] = 'Ce template existe déjà';
$lang['xs_clone_no_select'] = 'Vous devez choisir au moins un thème à dupliquer.';
...
$lang['xs_clone_back'] = '<a href="{URL}">Cliquer ici</a> pour retourner à la page de clônage des thèmes.';
...
$lang['xs_import_select_styles'] = 'Selectionner le(s) thème(s) à installer:';
...
$lang['xs_import_nogzip'] = 'Cette fonction requiert la compression gzip, et apparement celle-ci n\'est pas supportée sur ce serveur.';
$lang['xs_import_nowrite_cache'] = 'Impossible d\'écrire dans le cache. Cette fonction requiert que le cache doit être inscriptible. Vérifiez la configuration du MOD.<br /><br /><a href="{URL1}">Cliquer ici</a> pour rendre le cache inscriptible.<br /><br /><a href="{URL2}">Cliquer ici</a>pour revenir à la page d\'importation.';

$lang['xs_import_download_warning'] = 'Ceci vous amènera sur un site web externe où vous pourrez rapidement télécharger des thèmes avec simplement quelques clics en utilisant le système d\'importation du MOD eXtreme Styles.';

$lang['xs_clone_style'] = 'Dupliquer le thème';
$lang['xs_clone_style_explain'] = 'Ceci vous permet de rapidement de dupliquer un thème ou bien un template entier.<br /><br />Attention : Si vous copiez un template, veillez à ce que l\'auteur original du template vous autorise à le faire (sauf pour subSilver - vous pouvez faire ce que vous souhaitez avec subSilver). Normalement les auteurs autorisent que leurs thèmes soient modifiés, mais les thèmes modifiés ne doivent être distribués.';
...
$lang['xs_clone_style_explain3'] = 'Entrez le nom pour le nouveau thème que vous allez créer et cliquez sur le bouton "Dupliquer".';
$lang['xs_clone_style_explain4'] = 'Ceci vous permet de dupliquer un template. Vous pouvez également copier tous les thèmes associés à ce template. Plus tard, vous pourrez éditer les fichiers *.tpl, le nouveau template et l\'ancien template ne seront pas affectés.';

$lang['xs_clone_style_lc'] = 'Dupliquer le thème';
$lang['xs_clone_style2'] = 'Dupliquer le thème "{STYLE}":';
$lang['xs_clone_style3'] = 'Dupliquer le template "{STYLE}"';
$lang['xs_clone_newdir_name'] = 'Nom du nouveau template (répertoire):';
$lang['xs_clone_select'] = 'Sélectionner le(s) thème(s) à dupliquer:';
...
* install/uninstall
*/
$lang['xs_install_styles_explain2'] = 'Ceci est la liste des thèmes envoyés sur votre forum, mais qui ne sont pas installés. Cliquer sur le lien "installer" pour le thème que vous souhaitez installer, ou bien sélectionner plusieurs thèmes puis cliquer sur le bouton d\'envoi.';
$lang['xs_uninstall_styles_explain2'] = 'Ceci est la liste des thèmes installés sur votre forum. Cliquer sur le lien "Désinstaller" pour supprimer certains thèmes de ce forum. La désinstallation d\'un thème utilisé par des membres, modifie le thème de ces derniers, par le thème par défaut du forum. Aussi, supprimer un thème supprimera automatiquement le cache pour ce thème.';
...
$lang['xs_uninstall_lc'] = 'Désinstaller';
...
$lang['xs_install_none'] = 'Il n\'y a pas de nouveaux thèmes à installer. Tous les thèmes disponibles sont déjà installés.';
...
$lang['xs_fileedit_trim'] = 'Automatiquement supprimer les espace en début et fin de fichier.';
...
$lang['xs_update_total1'] = 'Total : {NUM} élément(s)';
$lang['xs_update_info1'] = 'Cette fonctionnalité d\'administration vous permet de vérifier les mises à jours disponibles de phpBB, de certains MODs et de certains thèmes installés sur votre forum. Si des mises à jours sont disponibles, il vous sera indiqué un lien où vous pourrez télécharger le fichier de mise à jour.<br /><br />Cette fonction nécessite les ports (sockets) pour être activée. Le plupart des hébergements gratuits ne permettent pas cette fonctionnalité, ainsi si ce forum est hébergé par un hébergeur gratuit (comme Lycos Multimania) vous ne pouvez pas utiliser cette fonction de mise à jour, mais si ce forum est sur un hébergeur "normal" tout devrait correctement se passer.<br /><br />Quand vous cliquerez sur "continuer", le script vérifiera tous les programmes installés sur ce forum. Si votre site est lent cela peut prendre un peu de temps. Soyez patient et ne cliquez pas sur "stop" si le temps d\'exécution de votre navigateur Internet n\'est pas terminé. Si le serveur est lent ou bien que la mise à jour du site est lente alors le temps d\'exécution du script doit être terminé - si cela arrive, vous devriez augmenter la valeur du temps d\'exécution.';
...
$lang['xs_update_downloadinfo'] = 'Lien de téléchargement';
...
$lang['xs_update_total3'] = 'Mises à jours disponibles : {NUM} élément(s)';
$lang['xs_update_select1'] = 'Sélectionner les objets élément(s) à mettre à jour';
...
$lang['xs_update_noupdate'] = 'Dernière version utilisée.';
...
$lang['xs_update_downloadinfo2'] = 'Télécharger/Informations';
$lang['xs_update_info'] = 'Site web';

$lang['xs_permission_denied'] = 'Permission refusée';

$lang['xs_download_lc'] = 'Télécharger';
...
//-- mod : move forum logo settings to ... - xs fix ----------------------------
//-- add
$lang['xs_data_theme_logo'] = 'Chemin du logo du forum';
//-- fin mod : move forum logo settings to ... - xs fix ------------------------

//-- mod : rank color system - xs fix ------------------------------------------
//-- add
$lang['xs_data_rcs_admincolor'] = 'Couleur du groupe administrateur';
$lang['xs_data_rcs_modcolor'] = 'Couleur du groupe modérateur';
$lang['xs_data_rcs_usercolor'] = 'Couleur du groupe utilisateur';
//-- fin mod : rank color system - xs fix --------------------------------------

//-- mod : bot indexing mod - xs fix -------------------------------------------
//-- add
$lang['xs_data_rcs_botcolor'] = 'Couleur des robots';
//-- fin mod : bot indexing mod - xs fix ---------------------------------------
