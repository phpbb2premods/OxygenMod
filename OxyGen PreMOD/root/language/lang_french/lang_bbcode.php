...
$faq[] = array("Créer du texte en gras, italique et souligné", "Le BBCode comprend des balises qui vous permettent de changer rapidement le style de votre texte. Cela se réalise des manières suivantes : <ul><li>Pour rendre une partie de texte en gras, placez-le dans <b>[b][/b]</b>; exemple : <br /><br /><b>[b]</b>Salut<b>[/b]</b><br /><br />donnera <b>Salut</b></li><li>Pour souligner un texte, utilisez <b>[u][/u]</b>; par exemple :<br /><br /><b>[u]</b>Bonjour<b>[/u]</b><br /><br />donnera <u>Bonjour</u></li><li>Pour mettre un texte en italique, utilisez <b>[i][/i]</b>; exemple :<br /><br />C'est <b>[i]</b>Super!<b>[/i]</b><br /><br />donnera C'est <i>Super!</i></li></ul>");
...
$faq[] = array("--", "Divers");
$faq[] = array("Puis-je ajouter mes propres balises ?", "Non, je crains que cela soit impossible directement dans phpBB 2.0. Nous offrirons la possibilité de personnaliser les balises BBCode dans la prochaine version majeure.");
