...
// please add it here.
$lang['TRANSLATION'] = 'Traduction originale par <a href="http://www.phpbb-fr.com/" title="phpBB-fr" target="_blank" class="copyright">phpBB-fr.com</a>, revue par <a href="http://www.ezcom-fr.com/" title="Communauté EzCom" target="_blank" class="copyright">EzCom</a>';
$lang['TRANSLATION_INFO'] = 'Traduction originale par <a href="http://www.phpbb-fr.com/" title="phpBB-fr" target="_blank" class="copyright">phpBB-fr.com</a>, revue par <a href="http://www.ezcom-fr.com/" title="Communauté EzCom" target="_blank" class="copyright">EzCom</a>';
...
$lang['View_newest_post'] = 'Message le plus récent';
...
$lang['Post_new_topic'] = 'Émettre un nouveau sujet';
$lang['Reply_to_topic'] = 'Répondre';
...
$lang['Online_users_zero_total'] = 'Il n\'y a <b>aucun</b> utilisateur connecté.';
$lang['Online_users_total'] = 'Il y a <b>%d</b> utilisateurs connectés :: ';
$lang['Online_user_total'] = 'Il y a <b>%d</b> utilisateur connecté :: ';
$lang['Reg_users_zero_total'] = 'aucun enregistré, ';
...
$lang['Guest_users_zero_total'] = 'aucun invité';
$lang['Guest_users_total'] = '%d invités';
$lang['Guest_user_total'] = '%d invité';
$lang['Record_online_users'] = 'Le record du nombre d\'utilisateurs connectés est de <b>%s</b> le %s'; // first %s = number of users, second %s is the date.
...
$lang['Search_unanswered'] = 'Messages sans réponse';
...
// Stats block text
//
$lang['Posted_articles_zero_total'] = 'Nos membres n\'ont émis aucun message'; // Number of posts
$lang['Posted_articles_total'] = 'Nos membres ont émis un total de <b>%d</b> messages'; // Number of posts
$lang['Posted_article_total'] = 'Nos membres ont émis un total de <b>%d</b> message'; // Number of posts
$lang['Registered_users_zero_total'] = 'Nous n\'avons <b>aucun</b> utilisateur enregistré'; // # registered users
$lang['Registered_users_total'] = 'Nous avons <b>%d</b> utilisateurs enregistrés'; // # registered users
$lang['Registered_user_total'] = 'Nous avons <b>%d</b> utilisateur enregistré'; // # registered users
$lang['Newest_user'] = 'L\'utilisateur enregistré le plus récent est <b>%s%s%s</b>'; // a href, username, /a 

$lang['No_new_posts_last_visit'] = 'Aucun nouveau message depuis votre dernière visite';
...
$lang['Forum_not_exist'] = 'Le forum sélectionné n\'existe pas.';
...
$lang['Rules_post_can'] = 'Vous <b>pouvez</b> émettre de nouveaux sujets dans ce forum';
$lang['Rules_post_cannot'] = 'Vous <b>ne pouvez pas</b> émettre de nouveaux sujets dans ce forum';
...
$lang['No_topics_post_one'] = 'Il n\'y a pas de messages dans ce forum<br />Cliquez sur le lien <b>Nouveau</b> sur cette page pour en émettre un.';
...
$lang['View_previous_topic'] = 'Sujet précédent';
...
$lang['Post_a_new_topic'] = 'Émettre un nouveau sujet';
$lang['Post_a_reply'] = 'Émettre une réponse';
$lang['Post_topic_as'] = 'Émettre le sujet en tant que';
$lang['Edit_Post'] = 'Éditer le sujet';
...
$lang['Empty_subject'] = 'Vous devez préciser le nom du sujet avant de pouvoir émettre un nouveau sujet.';
$lang['Empty_message'] = 'Vous devez saisir un message avant de pouvoir émettre.';
$lang['Forum_locked'] = 'Ce forum est verrouillé; vous ne pouvez ni émettre, ni répondre, ni éditer les sujets.';
$lang['Topic_locked'] = 'Ce sujet est verrouillé; vous ne pouvez ni éditer les messages, ni répondre.';
...
$lang['No_valid_mode'] = 'Vous pouvez seulement émettre, répondre, éditer ou citer des messages; veuillez revenir en arrière et réessayer.';
$lang['No_such_post'] = 'Il n\'y a aucun message de ce type; veuillez revenir en arrière et réessayer.';
$lang['Edit_own_posts'] = 'Vous pouvez uniquement éditer vos propres messages.';
$lang['Delete_own_posts'] = 'Vous pouvez uniquement supprimer vos propres messages.';
$lang['Cannot_delete_replied'] = 'Vous ne pouvez pas supprimer un message ayant eu des réponses.';
...
$lang['To_few_poll_options'] = 'Vous devez au moins insérer deux options au sondage.';
$lang['To_many_poll_options'] = 'Vous avez inséré trop d\'options au sondage.';
...
$lang['Poll_for_explain'] = '[ Insérez 0 ou laissez vide pour ne jamais terminer le sondage ]';
...
$lang['HTML_is_ON'] = 'HTML <u>activé</u>';
$lang['HTML_is_OFF'] = 'HTML <u>désactivé</u>';
$lang['BBCode_is_ON'] = '%sBBCode%s <u>activé</u>'; // %s are replaced with URI pointing to FAQ
$lang['BBCode_is_OFF'] = '%sBBCode%s <u>désactivé</u>';
$lang['Smilies_are_ON'] = 'Smilies <u>activés</u>';
$lang['Smilies_are_OFF'] = 'Smilies <u>désactivés</u>';

$lang['Attach_signature'] = 'Attacher sa signature (les signatures peuvent être modifiées dans le profil)';
$lang['Notify'] = 'Me prévenir lorsque quelqu\'un a répondu';

$lang['Stored'] = 'Message enregistré.';
$lang['Deleted'] = 'Message supprimé.';
$lang['Poll_delete'] = 'Votre sondage a été supprimé.';
...
$lang['No_new_pm'] = 'Messages privés';
...
$lang['You_no_new_pm'] = 'Aucun nouveau message privé ne vous attend dans votre boîte de réception';
...
$lang['Cannot_send_privmsg'] = 'L\'administrateur vous a empêché d\'envoyer des messages privés.';
...
$lang['Edit_message'] = 'Éditer un message privé';
...
$lang['No_folder'] = 'Aucun dossier spécifié';
...
$lang['Items_required'] = 'Les champs marqués d\'un * sont obligatoires.';
...
$lang['Send_private_message'] = 'Message privé';
...
$lang['File_no_data'] = 'Le fichier de l\'URL que vous avez donné ne contient aucune donnée';
$lang['No_connection_URL'] = 'Une connexion ne peut être établie avec l\'URL que vous avez donné';
$lang['Incomplete_URL'] = 'L\'URL que vous avez entré est incomplète';
...
$lang['Always_notify_explain'] = 'Envoie un e-mail lorsque quelqu\'un répond aux sujets que vous avez posté. Ceci peut être changé à chaque fois que vous émettez.';

$lang['Board_style'] = 'Thème du forum';
$lang['Board_lang'] = 'Langue du forum';
$lang['No_themes'] = 'Aucun thème dans la base de données';
...
$lang['Signature_explain'] = 'Ceci est un bloc de texte qui peut être ajouté aux messages que vous émettez. Il y a une limite de %d caractères';
...
$lang['Avatar'] = 'Avatar';
$lang['Avatar_explain'] = 'Affiche une petite image au-dessous de vos détails dans vos messages. Sa largeur ne peut pas dépasser %d pixels, sa hauteur %d pixels et la taille du fichier, pas plus de %d ko.';
...
$lang['Upload_Avatar_URL_explain'] = 'Entrez l\'URL de l\'avatar; elle sera copiée sur ce site.';
...
$lang['Password_mismatch'] = 'Les mots de passe que avez saisi sont différents.';
$lang['Current_password_mismatch'] = 'Le mot de passe que vous avez saisi est différent de celui stocké dans la base de données.';
$lang['Password_long'] = 'Votre mot de passe ne doit pas dépasser 32 caractères.';
$lang['Username_taken'] = 'Ce nom d\'utilisateur est déjà utilisé.';
$lang['Username_invalid'] = 'Ce nom d\'utilisateur contient un caractère invalide comme \' par exemple.';
$lang['Username_disallowed'] = 'Ce nom d\'utilisateur a été interdit d\'utilisation.';
$lang['Email_taken'] = 'Cette adresse e-mail est déjà utilisée par un autre utilisateur.';
$lang['Email_banned'] = 'Cette adresse e-mail a été bannie.';
...
$lang['No_email_match'] = 'L\'adresse e-mail que vous avez fourni ne correspond pas avec celle qui a été utilisée pour ce nom d\'utilisateur.';
...
$lang['Email_message_desc'] = 'Ce message sera envoyé en mode texte uniquement; n\'insérez aucun code HTML ou BBCode. L\'adresse de réponse pour ce message sera celle de votre e-mail.';
...
//
$lang['Confirm_code_wrong'] = 'Le code de confirmation que vous avez saisi ne correspond pas à celui de l\'image. Veuillez réessayer ultérieurement.';
$lang['Too_many_registers'] = 'Vous avez dépassé le nombre de tentatives d\'enregistrement pour cette session. Veuillez réessayer ultérieurement.';
...
$lang['Group_joined'] = 'Vous vous êtes inscrit à ce groupe.<br />Vous serez averti lorsque votre inscription sera approuvée par le modérateur du groupe.';
...
$lang['Group_type_updated'] = 'Vous avez mis à jour le type du groupe.';
...
$lang['Confirm_unsub'] = 'Etes-vous certain(e) de vouloir vous désinscrire de ce groupe ?';
$lang['Confirm_unsub_pending'] = 'Votre inscription à ce groupe n\'a pas encore été approuvée; êtes-vous certain(e) de vouloir vous désinscrire ?';
...
$lang['This_closed_group'] = 'Ceci est un groupe fermé : plus aucun utilisateur n\'est accepté';
$lang['This_hidden_group'] = 'Ceci est un groupe invisible : l\'ajout automatique d\'utilisateurs n\'est pas autorisé';
...
$lang['Search_Flood_Error'] = 'Vous ne pouvez pas lancer une autre recherche si rapidement après la dernière effectuée; veuillez réessayer à nouveau dans un court moment.';
...
$lang['Sorry_auth_announce'] = 'Seuls les %s peuvent émettre des annonces dans ce forum.';
$lang['Sorry_auth_sticky'] = 'Seuls les %s peuvent émettre des post-it dans ce forum.';
$lang['Sorry_auth_read'] = 'Seuls les %s peuvent lire des sujets dans ce forum.';
$lang['Sorry_auth_post'] = 'Seuls les %s peuvent émettre dans ce forum.';
$lang['Sorry_auth_reply'] = 'Seuls les %s peuvent répondre aux messages dans ce forum.';
$lang['Sorry_auth_edit'] = 'Seuls les %s peuvent éditer des messages dans ce forum.';
...
// Viewonline
//
$lang['Reg_users_zero_online'] = 'Il n\'y a aucunutilisateur enregistré et '; // There are 5 Registered and
...
$lang['Guest_users_zero_online'] = 'Il n\'y a aucun invité en ligne'; // There are 10 Guest users online
...
$lang['Posting_message'] = 'Émet un message';
...
$lang['Confirm_delete_topic'] = 'Etes-vous certain(e) de vouloir supprimer le(s) sujet(s) sélectionné(s) ?';
$lang['Confirm_lock_topic'] = 'Etes-vous certain(e) de vouloir verrouiller le(s) sujet(s) sélectionné(s) ?';
$lang['Confirm_unlock_topic'] = 'Etes-vous certain(e) de vouloir déverrouiller le(s) sujet(s) sélectionné(s) ?';
$lang['Confirm_move_topic'] = 'Etes-vous certain(e) de vouloir déplacer le(s) sujet(s) sélectionné(s) ?';
...
$lang['Too_many_error'] = 'Vous avez sélectionné trop de messages. Vous ne pouvez sélectionner qu\'un seul message pour diviser le sujet à partir de ce message!';
...
$lang['Other_IP_this_user'] = 'Autres adresses IP à partir desquelles cet utilisateur a émis';
...
$lang['Please_remove_install'] = 'Veuillez vous assurer que le dossier <em>/install/</em> est bien supprimé';
