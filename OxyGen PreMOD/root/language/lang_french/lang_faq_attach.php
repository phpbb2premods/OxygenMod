...
/** 
*
* attachment mod faq [French]
*
* @package attachment_mod
* @version $Id: lang_faq_attach.php,v 1.1 2005/11/27 17:43:13 kooky Exp $
...
$faq[] = array("Pourquoi ne puis-je pas voir et télécharger des fichiers joints ?", "Sur certains forums, voir et télécharger des fichiers peut-être limité a certains utilisateurs ou groupes. Pour voir et télécharger des fichiers joints, vous pouvez avoir besoin d'une autorisation spéciale. Seul le modérateur du forum et le webmaster peuvent accorder ces accés, vous devriez les contacter.");

$faq[] = array("Qui dois-je contacter en cas de fichiers joints ill&eacute;gaux ou susceptibles d'&ecirc;tre ill&eacute;gaux ?", "Vous devriez contacter le webmaster. Si vous n'arrivez pas &agrave; le contacter, vous devriez d'abord contacter un des mod&eacute;rateurs du forum et lui demander avec qui vous devriez prendre contact. Si vous ne recevez toujours pas de r&eacute;ponse, vous devriez contacter le propri&eacute;taire du domaine (faîtes une recherche avec un \"whois\") ou, si ce forum fonctionne sur un h&eacute;bergeur gratuit (par exemple: yahoo, free.fr, f2s.com, etc.), la direction ou le service des abus de l'h&eacute;bergeur. Veuillez noter que le Groupe phpBB n'a absolument aucun contrôle et ne peut en aucun cas &ecirc;tre tenu pour responsable en ce qui concerne la mani&egrave;re, le lieu ou par qui ce site est utilis&eacute;. Il est totalement inutile de prendre contact avec le Groupe phpBB pour tout ce qui ne concerne pas l'aspect l&eacute;gal (cessation et d&eacute;sistement, responsabilit&eacute;, commentaire diffamatoire, etc.) en relation directe avec le site web phpbb.com ou s'apparentant au programme de phpBB lui-m&ecirc;me. Si vous envoyez un e-mail au Groupe phpBB concernant une utilisation non conforme de ce programme par une tiers personne, alors vous devriez vous attendre &agrave; une r&eacute;ponse laconique, voire m&ecirc;me &agrave; aucune r&eacute;ponse.");
