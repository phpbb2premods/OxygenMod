...
{
	global $attach_config, $is_auth, $lang;
	...
	$image = '<img src="' . $attach_config['topic_icon'] . '" alt="' . $lang['Attached_files'] . '" title="' . $lang['Attached_files'] . '" border="0" /> ';
...
{
	global $attach_config, $userdata, $lang;
...
//-- add
					'L_CLICKFULLSIZE' => $lang['Image_link_clickfullsize'],
...
//-- fin mod : thumbnail-on-dimensions -----------------------------------------
				...
				if ($image)
				{
					...
					$template->assign_block_vars('postrow.attach.cat_images', array(
						...
						'SIZE_VAR'			=> $size_lang,
						'COMMENT'			=> $comment,
						'L_ATTACHED_FILE'	=> $lang['Attached_file'],
